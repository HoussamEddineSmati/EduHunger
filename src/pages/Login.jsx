        ...
        <HeroBackground>
            ...
            <nav className="px-8 py-6">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <Link to="/register" className="px-5 py-2 border border-white/30 text-white text-sm rounded-full hover:bg-white/10 transition-all">
                        Create Account
                    </Link>
                </div>
            </nav>
            ...
            {/* Form Container */}
            <div className="flex items-center justify-center px-6 mt-4 sm:mt-10">
                <div className="w-full max-w-md">
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl p-8 sm:p-10">
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-extralight text-white tracking-tight">Welcome Back</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-white/15 hover:bg-white/25 border border-white/20 text-white font-medium py-3 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed tracking-wide"
                            >
                        ...
                        <p className="text-center mt-6 text-sm text-white/40">
                            Are you new?{' '}
                            <Link to="/register" className="font-medium text-white/80 hover:text-white transition-colors">
                                Create an Account
                            </Link>
                        </p>
                    </div>
